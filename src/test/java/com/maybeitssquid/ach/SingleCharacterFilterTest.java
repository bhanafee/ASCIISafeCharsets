...
/**
 * Unit tests for {@link SingleCharacterFilter}.
 * The apply method filters out results that are not single characters, returning
 * an empty string for inputs that resolve to multi-character or empty outputs.
 */
